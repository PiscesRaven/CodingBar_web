...
$(".class4").click(function () {
 ...
 $(document).ready(function () {
   ...
   $("#yt_3,#yt_4").click(function () {	
	 ...
	 $(".Jclass1,.a_class").click(function () {
		$('#navbar-class').animate( { scrollLeft: '0' }, 1000);
 		$("html,body").stop().animate({
 			scrollTop: $(".class1_go").offset().top - navHeight
 		}, 800);
 	});
	  $(".Jclass2,.b_class").click(function () {
		$('#navbar-class').animate( { scrollLeft: '200' }, 1000);
 		$("html,body").stop().animate({
 			scrollTop: $(".class2_go").offset().top - navHeight
 		}, 800);
 	});
	  $(".Jclass3").click(function () {	 
		$('#navbar-class').animate( { scrollLeft: '350' }, 1000);
 		$("html,body").stop().animate({
 			scrollTop: $(".class3_go").offset().top - navHeight
 		}, 800);
 	});
	  $(".Jclass4").click(function () {
		$('#navbar-class').animate( { scrollLeft: '450' }, 1000);
 		$("html,body").stop().animate({
 			scrollTop: $(".class4_go").offset().top - navHeight
 		}, 800);
 	});
	  $(".Jclass5").click(function () {	
		$('#navbar-class').animate( { scrollLeft: '550' }, 1000);
 		$("html,body").stop().animate({
 			scrollTop: $(".class5_go").offset().top - navHeight
 		}, 800);
 	});
	 $("#level1").click(function () {
 		$("html,body").stop().animate({
 			scrollTop: $(".level1").offset().top - navHeight
 		}, 800);
 	});
	 $("#level2").click(function () {
 		$("html,body").stop().animate({
 			scrollTop: $(".level2").offset().top - navHeight
 		}, 800);
 	});
	 $("#level3").click(function () {
 		$("html,body").stop().animate({
 			scrollTop: $(".level3").offset().top - navHeight
 		}, 800);
 	});
	 $("#level4").click(function () {
 		$("html,body").stop().animate({
 			scrollTop: $(".level4").offset().top - navHeight
 		}, 800);
 	});
	 $("#level5").click(function () {
 		$("html,body").stop().animate({
 			scrollTop: $(".level5").offset().top - navHeight
 		}, 800);
 	});
});
$(window).scroll(function () {
		if ($(window).width() > 0) {
			if ($(this).scrollTop() > 10) {
				$('header').addClass('boxshow2');
				$('.onlyclass').addClass('boxshow');
				$('.scroll_show').fadeIn(500);
			}else {
				$('header').removeClass('boxshow2');
				$('.onlyclass').removeClass('boxshow');
    ...
    $(window).on('resize', debounce(function() {
		...
		var home_top2 = 872;
         if (_windowWidth > 1025 &&_windowHeight>770){
            $(".main-section,.movie-section,.moblie_Change,#top_banner").mouseover(
            function(e) {
		...
		if (_windowWidth > 701 &&_windowHeight>0){
			$("#navbar-class").sticky({ topSpacing: 120,responsiveWidth: true});
        };
		if (_windowWidth < 700 &&_windowHeight>0){
			$("#navbar-class").sticky({ topSpacing: 80,responsiveWidth: true});
        };
    }, 0));
